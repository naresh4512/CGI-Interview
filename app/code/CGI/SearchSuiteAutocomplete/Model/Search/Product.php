...
namespace CGI\SearchSuiteAutocomplete\Model\Search;
...
use \CGI\SearchSuiteAutocomplete\Model\Source\AutocompleteFields;
use \CGI\SearchSuiteAutocomplete\Model\Source\ProductFields;
 ...
 */
class Product implements \CGI\SearchSuiteAutocomplete\Model\SearchInterface
{
    /**
    ...
    {
        /** @var \CGI\SearchSuiteAutocomplete\Block\Autocomplete\ProductAgregator $productAgregator */
        $productAgregator = $this->objectManager->create(
            'CGI\SearchSuiteAutocomplete\Block\Autocomplete\ProductAgregator'
        )
                                                ->setProduct($product);
