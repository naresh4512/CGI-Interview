...
namespace CGI\SearchSuiteAutocomplete\Block\Autocomplete;

use \CGI\SearchSuiteAutocomplete\Block\Product as ProductBlock;
...
{
    /**
     * @var \CGI\SearchSuiteAutocomplete\Block\Product
     */
    ...
    public function getAddToCartData()
    {
        $formUrl             = $this->productBlock->getAddToCartUrl(
            $this->getProduct(),
            ['cgi_searchsuiteautocomplete' => true]
        );
